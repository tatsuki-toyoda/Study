...
SELECT goods_name, goods_code, price FROM goods_table
WHERE price >= 20000;
...
SELECT  store_table.store_code, stock_table.goods_code, stock_table.quantity FROM stock_table
JOIN store_table on stock_table.store_code = store_table.store_code
WHERE store_table.store_code = 'EA03';
